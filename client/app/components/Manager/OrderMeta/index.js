        ...
        <Col xs='12' md='8'>
          ...
          {user.role === ROLES.Admin && (
            <>
              <Row>
                <Col xs='4'>
                  <p className='one-line-ellipsis'>Mobile</p>
                </Col>
                <Col xs='8'>
                  {<span className='order-label'>{order.phoneNumber}</span>}
                </Col>
              </Row>
              <Row>
                <Col xs='4'>
                  <p className='one-line-ellipsis'>Delivery Address</p>
                </Col>
                <Col xs='8'>
                  {<span className='order-label'>{order.deliveryAddress}</span>}
                </Col>
              </Row>
            </>
          )}
