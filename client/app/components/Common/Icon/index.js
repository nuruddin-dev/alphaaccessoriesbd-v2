...
const ProfileIcon = () => {
  return (
    <svg
      ...
      xmlns='http://www.w3.org/2000/svg'
      viewBox='0 0 24 24' // Ensure this matches the icon's bounds
      fill='none' // No fill for the icon, only stroke
    >
      <path
        d='M12 12c2.21 0 4-1.79 4-4s-1.79-4-4-4-4 1.79-4 4 1.79 4 4 4zM4 18c0-2.21 2.69-4 6-4h4c3.31 0 6 1.79 6 4v2H4v-2z'
        stroke='currentColor' // Using stroke to color the icon
...
const AboutIcon = () => {
  return <span className='info-icon fa fa-info-circle' aria-hidden='true' />;
};
